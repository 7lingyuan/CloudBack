...
void MainWindow::initWindow()
{
    ...
    hlayout->addWidget(ui->sideBar);
    hlayout->addWidget(ui->stackedWidget);

    QPixmap pixmap(":/Icon/cloud45.png");
    ...
    vlayout->addWidget(ui->labelIcon);
    vlayout->addSpacing(15);
    vlayout->addWidget(ui->toolButtonFile);
    vlayout->addSpacing(10);
    vlayout->addWidget(ui->toolButtonTranslation);
    vlayout->addStretch();
    vlayout->addWidget(ui->toolButtonPerson);
